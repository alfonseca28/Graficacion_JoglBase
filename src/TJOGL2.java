...
/**
 * JOGL 2.0 Program Template (GLCanvas) This is a "Component" which can be added into a top-level "Container". It also handles the OpenGL events to render graphics.
 */
...
public class TJOGL2 extends GLCanvas implements GLEventListener, KeyListener {
    ...
    /**
     * Render 2 unit cube with texture coordinates, mapped to 8 separate faces in texture image. ___________ | | T | | |___|___|___| | L | F | R | |___|___|___| | | B | BB| |___|___|___|
     */
